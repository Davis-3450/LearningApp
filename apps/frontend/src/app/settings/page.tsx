      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <Tabs defaultValue="appearance" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 h-auto">
            <TabsTrigger value="appearance" className="flex flex-col gap-1 h-16 px-2">
              <Palette className="h-4 w-4" />
              <span className="text-xs">Appearance</span>
            </TabsTrigger>
            <TabsTrigger value="study" className="flex flex-col gap-1 h-16 px-2">
              <BookOpen className="h-4 w-4" />
              <span className="text-xs">Study</span>
            </TabsTrigger>
            <TabsTrigger value="accessibility" className="flex flex-col gap-1 h-16 px-2">
              <Accessibility className="h-4 w-4" />
              <span className="text-xs">Accessibility</span>
            </TabsTrigger>
            <TabsTrigger value="about" className="flex flex-col gap-1 h-16 px-2">
